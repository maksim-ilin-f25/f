...
//
//    rootContext.set(FAtom("plus"), FValue.Function(FFunction.Builtin { args, context -> plus(args,
// context) }))
//    rootContext.set(FAtom("minus"), FValue.Function(FFunction.Builtin { args, context ->
// minus(args, context) }))
//    rootContext.set(FAtom("times"), FValue.Function(FFunction.Builtin { args, context ->
// times(args, context) }))
//    rootContext.set(FAtom("divide"), FValue.Function(FFunction.Builtin { args, context ->
// divide(args, context) }))
//    rootContext.set(FAtom("head"), FValue.Function(FFunction.Builtin { args, context -> head(args,
// context) }))
//
...
// }
//
// fun evaluateListTo(list: MutableList<FValue>, ast: List<FElement>, context: FContext):
